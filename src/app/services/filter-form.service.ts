...
import { EventForm, PropertyForm, FilterForm, EventValue } from '../models/event';
...
export class FilterFormService {
  ...
  createPropertyForm(data?: Partial<{ name: string | null; type: string | null; value: string | null; valueTo: string | null; operator: string | null }>): FormGroup<PropertyForm> {
